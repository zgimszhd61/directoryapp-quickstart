        ...
        <div className="w-full py-8 flex flex-col md:px-40 px-4">
            ...
            <div className="py-10 grid w-full gap-6 grid-cols-1 md:grid-cols-3">
                {dataList.map((item, index) => (
                    <div
                        className="px-5 py-7 w-full flex flex-col gap-2 rounded-lg cursor-pointer transition-all hover-opacity-70 border border-gray-700"
                        key={index}
                    >
                        <div className="flex flex-row items-center gap-2">
                            ...
                            <div className="flex flex-col gap-2 pt-2">
                                <div className="flex flex-row items-center">
                                    ...
                                    <hr className="text-sm text-gray-500 tracking-tight"></hr>
                                </div>
                            </div>
                        </div>
                    </div>
